...
- **Phase 6:** Expansion. Local entity graph tables, frontmatter-derived indexing, enhancement-result entity linking, shared-file connection query, typed entity-edge query/upsert helpers, typed memory-file reasoning edges, and temporal validity sweep helpers shipped. Pyramid summaries, import pipelines, and portable profile export remain.
