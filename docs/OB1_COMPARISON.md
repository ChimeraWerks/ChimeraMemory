...
19. **Import pipelines:** ChatGPT export, Perplexity, Obsidian vault, X/Twitter, Instagram, Google Activity, Grok, Gmail, Atom/Blogger. ChatGPT, Obsidian, Gmail, Perplexity, Grok, X/Twitter, Instagram, and Google Activity scaffolding shipped; more importers can reuse the same governed-write pattern. (OB1 ref: `recipes/*-import/`)
